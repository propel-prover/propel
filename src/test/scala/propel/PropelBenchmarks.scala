...
def benchmarks(properties: Properties = None) = List(
  ...
  "natlist_version_bcounter" -> nat_max(natlist_gcounter(natlist_version_bcounter("Unit", properties))),
  "bvlist_version_bcounter" -> bv_eq(bv_max(bvlist_gcounter(bvlist_version_bcounter("Unit", properties)))),
  "natlist_bcounter" -> nat_max(natlist_gcounter(natlist_version_bcounter(natlist_pncounter(natlist_bcounter("Unit", properties))))),
  "bvlist_bcounter" -> bv_eq(bv_max(bvlist_gcounter(bvlist_version_bcounter(bvlist_pncounter(bvlist_bcounter("Unit", properties)))))),
